...
Update July 14, 2022: For peer review, the URL objects are defined in a separate code because they have identifying information.
```{r eval=TRUE, eval=TRUE, message = FALSE, warning = FALSE, echo=TRUE}
# Import these look-up tables from Github for convenience.
#They are written elsewhere so this code doesn't have any identifying information.
library(here)
